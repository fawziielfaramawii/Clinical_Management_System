...
# Login button
login_btn = Button(text="Login", width=14, font=("Arial", 12, "bold"),
                   borderwidth=1, background="#ac6e52", fg="white", cursor="hand2", command=connect_database)
login_btn.place(x=483, y=315)
...
# reset_pass
reset_pass =Button(text="Forgot Password?",  width=15, font=("Arial", 9, "bold underline"), bg="white",
                      fg="blue", cursor="hand2", bd=0, command=reset_page)
reset_pass.place(x=430, y=400)


# Going to Login Page
sign_btn = Button(text="SignUp", width=13, font=("Arial", 9, "bold underline"), bg="white",
                      fg="red", cursor="hand2", bd=0, command=signup_page)
